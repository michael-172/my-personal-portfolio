...
const InfoItemHorizontal = () => {
  return (
    <div className="flex items-center animate-pulse gap-2 absolute bottom-0 left-0  py-4 px-8 w-[255px] h-[107px] shrink-0 [background:#FFF] shadow-[5px_5px_10px_0px_rgba(124,124,124,0.20)] rounded-[20px]">
