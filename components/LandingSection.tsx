...
const LandingSection = () => {
  return (
    <div className="w-full relative flex shrink-0 [background:#EDF5FE] h-[calc(100vh-100px)]">
      <div className="container mx-auto   w-full h-full *:w-full *:h-full *:flex  grid grid-cols-2 gap-[90px]">
        <div className="1 flex  flex-col ">
          <div className="w-full h-full items-start justify-center flex flex-col gap-12">
        ...
        <div className="2 hidden xl:flex xl:items-center xl:flex-col xl:justify-end">
